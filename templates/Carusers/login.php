<!doctype html>
  ...
  <div class="d-md-flex half">
    ...
    <?= $this->Form->end() ?><br><p>
     ...
     <?= $this->Html->link(__('Add User'), ['prefix'=>false,'controller'=>'Carusers','action' => 'add']) ?><br>
     <?= $this->Html->link(__('Forgot Password?'), ['prefix'=>false,'controller'=>'Carusers','action' => 'forgotpassword']) ?>
